        ...
        try {
            ...
            if (response.ok) {
                ...
                if (response.status === 404) {
                    toast.error("Error 404: The update route is missing on the server. Please check your admin-router.js file.");
                    console.error("404 Error: The endpoint /api/admin/contact-content was not found. Ensure it is defined in your backend router.");
                    return;
                }
                let errorData = {};
            ...
            // This will show if it's a CORS error or if the server is unreachable
